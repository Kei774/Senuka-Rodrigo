...
function ScrollBackdrop() {
  ...
  const orbAY = useTransform(scrollYProgress, [0, 1], [0, 380]);
  const orbAX = useTransform(scrollYProgress, [0, 1], [0, -140]);
  const orbAS = useTransform(scrollYProgress, [0, 1], [1, 1.32]);

  const orbBY = useTransform(scrollYProgress, [0, 1], [0, -300]);
  const orbBX = useTransform(scrollYProgress, [0, 1], [0, 110]);
  const orbBS = useTransform(scrollYProgress, [0, 1], [1, 1.2]);

  const sweepY = useTransform(scrollYProgress, [0, 1], ["-20%", "120%"]);
  const sweepO = useTransform(scrollYProgress, [0, 0.12, 0.92, 1], [0.2, 0.48, 0.48, 0.25]);
  ...
  return (
    <div className="scroll-bg" aria-hidden>
      ...
      <div className="bg-bird" />
      <div className="bg-bird bg-bird-alt" />
    </div>
  );
}
